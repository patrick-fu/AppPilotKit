...
const CATALOG_READ_ERROR_KINDS: &[&str] = &[
...
const CATALOG_INVOKE_ARGUMENTS: &[ArgumentSpec] = &[
    ArgumentSpec {
        id: "authorization-grant",
        long: Some("authorization-grant"),
        short: None,
        aliases: &[],
        value_name: Some("GRANT"),
    ...
    ArgumentSpec {
        id: "capability",
        long: Some("capability"),
        short: None,
        aliases: &[],
        value_name: Some("CAPABILITY"),
    ...
    ArgumentSpec {
        ...
        long: Some("declaration-revision"),
        short: None,
        aliases: &[],
        value_name: Some("REVISION"),
    ...
    ArgumentSpec {
        id: "input-schema-id",
        long: Some("input-schema-id"),
        short: None,
        aliases: &[],
        value_name: Some("SCHEMA"),
    ...
    ArgumentSpec {
        ...
        long: Some("input-schema-revision"),
        short: None,
        aliases: &[],
        value_name: Some("REVISION"),
...
const CATALOG_LIST_ARGUMENTS: &[ArgumentSpec] = &[
    ArgumentSpec {
        id: "cursor",
        long: Some("cursor"),
        short: None,
...
const CATALOG_QUERY_ARGUMENTS: &[ArgumentSpec] = &[
    ArgumentSpec {
        id: "capability",
        long: Some("capability"),
        short: None,
    ...
    ArgumentSpec {
        ...
        long: Some("value-schema-revision"),
        short: None,
        aliases: &[],
        value_name: Some("REVISION"),
...
const CATALOG_SCHEMA_ARGUMENTS: &[ArgumentSpec] = &[
    ArgumentSpec {
        id: "capability",
        long: Some("capability"),
        short: None,
...
const CATALOG_SHOW_ARGUMENTS: &[ArgumentSpec] = &[
    ArgumentSpec {
        id: "capability",
        long: Some("capability"),
        short: None,
...
const CATALOG_CHILDREN: &[CommandSpec] = &[
    CommandSpec {
        name: "invoke",
        aliases: &[],
        about: "Invoke one Semantic Action through an opened Protocol Session",
        arguments: CATALOG_INVOKE_ARGUMENTS,
        children: &[],
        result_schema_id: Some("https://apppilotkit.dev/cli/v1/catalog.schema.json#/$defs/invoke"),
        result_fields: &["capability", "completed", "declaration_revision"],
        error_kinds: &[
            "action.conflict",
        ...
        side_effect: SideEffect::AppMutation,
        retry_safety: RetrySafety::RequiresIdempotencyKey,
    },
    CommandSpec {
        name: "list",
        aliases: &[],
        about: "List Semantic Catalog entries from an opened Protocol Session",
        arguments: CATALOG_LIST_ARGUMENTS,
        children: &[],
        result_schema_id: Some("https://apppilotkit.dev/cli/v1/catalog.schema.json#/$defs/list"),
        result_fields: &["capabilities", "catalog"],
        error_kinds: CATALOG_READ_ERROR_KINDS,
    ...
    CommandSpec {
        name: "query",
        aliases: &[],
        about: "Query one Semantic Resource through an opened Protocol Session",
        arguments: CATALOG_QUERY_ARGUMENTS,
        children: &[],
        result_schema_id: Some("https://apppilotkit.dev/cli/v1/catalog.schema.json#/$defs/query"),
        result_fields: &["bytes", "value", "value_schema"],
        error_kinds: CATALOG_READ_ERROR_KINDS,
        side_effect: SideEffect::ReadOnly,
        retry_safety: RetrySafety::Safe,
    },
    CommandSpec {
        name: "schema",
        aliases: &[],
        about: "Retrieve one live App schema document from an opened Protocol Session",
        arguments: CATALOG_SCHEMA_ARGUMENTS,
        children: &[],
        result_schema_id: Some("https://apppilotkit.dev/cli/v1/catalog.schema.json#/$defs/schema"),
        result_fields: &["document", "schema"],
        error_kinds: CATALOG_READ_ERROR_KINDS,
        side_effect: SideEffect::ReadOnly,
        retry_safety: RetrySafety::Safe,
    },
    CommandSpec {
        name: "show",
        aliases: &[],
        about: "Show one Semantic Capability declaration from an opened Protocol Session",
        arguments: CATALOG_SHOW_ARGUMENTS,
        children: &[],
        result_schema_id: Some("https://apppilotkit.dev/cli/v1/catalog.schema.json#/$defs/show"),
        result_fields: &[
...
const ROOT_CHILDREN: &[CommandSpec] = &[
    ...
    CommandSpec {
        name: "catalog",
        aliases: &[],
        about: "Inspect and invoke App-registered Semantic Catalog capabilities through an opened Protocol Session",
        arguments: &[],
...
pub(crate) fn capability_manifest<'a>(
    ...
    CapabilityManifest {
        ...
        error_kinds: vec![
            ...
            ManifestErrorKind {
                kind: "session.selectionRequired",
                exit_code: 4,
            },
            ManifestErrorKind {
                kind: "sessionExpired",
...
fn root_guidance(executable: &str) -> String {
    format!(
        "Safe start: {executable} capabilities --output json\n\
         ...
         Bounded output: inspect disclosure.truncated and next_actions; continue live catalog pages with {executable} catalog list --cursor CURSOR.\n\
